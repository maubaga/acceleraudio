...
public class SongCreator {
	...
	public boolean createWavFile(Context context, String songName){
		try {
			...
			// Create the data to add to the song (merge the arrays).
	...
	/**
	 * This method creates the header of the wav file as described by https://ccrma.stanford.edu/courses/422/projects/WaveFormat/
	...
	public boolean createNewSession(Context context, String session_name){
		...
		if (byteRequest > freeByte){
			Toast.makeText(context, context.getResources().getString(R.string.memory_error), Toast.LENGTH_LONG).show();
			return false;
		}
		...
		if(!isSaved){
			Toast.makeText(context, context.getResources().getString(R.string.img_error), Toast.LENGTH_LONG).show();
			return false;
		}
		...
		if(!isCreated){
			Toast.makeText(context, context.getResources().getString(R.string.track_creation_error), Toast.LENGTH_LONG).show();
			return false;
		}
	...
	public boolean modifySession(Context context, String session_name, String oldSessionName){
		...
		if(!isCreated){
			Toast.makeText(context, context.getResources().getString(R.string.creation_error), Toast.LENGTH_LONG).show();
			return false;
		}
