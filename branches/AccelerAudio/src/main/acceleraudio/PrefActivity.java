...
public class PrefActivity extends ActionBarActivity {
	...
	/**
	 * This method is called when the Layout of time choosing is pressed. It's show an AlterDialog that permits to select the time.
	 * @param view The view that call this method.
	 */
